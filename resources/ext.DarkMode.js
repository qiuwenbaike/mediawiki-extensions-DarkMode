...
$( function ( mw ) {
	var initialDarkMode = ( $( 'html' ).attr( 'class' ) ).indexOf( 'client-darkmode' ) > -1 || $.cookie( 'darkmode' ) === 1 ? 1 : 0;

	if ( !initialDarkMode && window.matchMedia( '( prefers-color-scheme: dark )' ).matches ) {
